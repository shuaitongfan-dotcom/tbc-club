	...
	links: [
		...
		// 支持自定义导航栏链接，支持多级菜单
		{
			...
			children: [
				...
				{
					name: "QQ",
					url: "https://qm.qq.com/q/ppRYhzGJaw",
					external: true,
					icon: "fa7-brands:qq",
				},
				// {
...
export const profileConfig: ProfileConfig = {
	...
	links: [
		...
		},
		{
			name: "Gitee",
			icon: "mdi:git",
			url: "https://gitee.com/fan-shuaitong",
		},
		{
			name: "GitHub",
			icon: "fa7-brands:github",
			url: "https://github.com/shuaitongfan-dotcom",
		},
		// {
		// 	name: "Codeberg",
...
export const announcementConfig: AnnouncementConfig = {
	...
	content: "欢迎各位小伙伴们加入燃色国风漫研社！", // 公告内容
...
export const footerConfig: FooterConfig = {
	...
	customHtml:
		'<p>ICP备案：<a href="https://beian.miit.gov.cn/">豫ICP备2026006045号</a></p>', // HTML格式的自定义页脚信息，例如备案号等，默认留空
...
export const pioConfig: import("./types/config").PioConfig = {
	...
	dialog: {
		...
		link: "https://github.com/shuaitongfan-dotcom", // 关于链接
	},
};
