...
export const zh_CN: Translation = {
	...
	[Key.timelineEducation]: "社区历史", //教育经历
	[Key.timelineWork]: "重大事件", //工作经历
	[Key.timelineProject]: "美好回忆", //项目经历
	...
	[Key.timelineProjects]: "事件数", //项目数
	[Key.timelineExperience]: "其他", //工作经验
